...
3. Fair-play API contract: stop returning correct answers in daily quiz payload ✅ COMPLETE
...
- **PR D**: ✅ Implemented fair-play payload change removing daily quiz answer leakage.
