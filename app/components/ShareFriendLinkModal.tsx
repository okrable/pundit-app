...
interface ShareFriendLinkModalProps {
  visible: boolean;
  code: string;
  shareUrl: string;
  onClose: () => void;
...
export default function ShareFriendLinkModal({
  visible,
  code,
  shareUrl,
  onClose,
}: ShareFriendLinkModalProps) {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: `Join my Pundit leaderboard! ${shareUrl}`,
        title: 'Pundit - Add Friend',
      });
    } catch (error) {
        ...
        <View style={styles.modal}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>
              Share this link to add them to your leaderboard
            </Text>
          </View>
